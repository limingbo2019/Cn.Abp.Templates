...
{
    [DependsOn(
        typeof(AbpAutofacModule),//DI
        typeof(AbpAspNetCoreMvcUiMultiTenancyModule),//多租户
        typeof(AbpAspNetCoreSerilogModule),//日志模块
        typeof(AbpSwashbuckleModule)//swagger模块
    )]
    
    [DependsOn(typeof(AbpCachingStackExchangeRedisModule))]//缓存redis

    [DependsOn(typeof(AbpEventBusRabbitMqModule))]//消息队列

    [DependsOn(typeof(AbpAuditLoggingEntityFrameworkCoreModule))]//审计日志
    ...
    public class MyProjectNameHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureAuditing(IConfiguration configuration)
        {
            ...
            Configure<AbpAuditingOptions>(options =>
            {
                ...
                options.ApplicationName = configuration["Auditing:ApplicationName"];
            });
        }
